...
/**
 * Class ReservationHmsMigrationDepositCheck
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class ReservationHmsMigrationDepositCheck extends Model
{
	protected $table = 'reservation_hms_migration_deposit_check';
