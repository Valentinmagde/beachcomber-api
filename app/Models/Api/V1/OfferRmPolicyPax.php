...
/**
 * Class OfferRmPolicyPax
 * 
 * @property int $offer_pax_policy_id
 * @property int $offer_id
 * @property string $pax_condition_type
 * @property int $adult_pax
 * @property int $min_adult_pax
 * @property int $child_pax
 * @property int $min_child_pax
 * @property int $teen_pax
 * @property int $min_teen_pax
 *
 * @package App\Models
 */
class OfferRmPolicyPax extends Model
{
	protected $table = 'offer_rm_policy_pax';
