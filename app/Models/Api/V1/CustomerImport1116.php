 ...
 * @property float|null $hms_customer_id
 ...
 * @package App\Models
 */
class CustomerImport1116 extends Model
{
	protected $table = 'customer_import_11_16';
	protected $primaryKey = 'customer_id';
	public $timestamps = false;

	protected $casts = [
		'hms_customer_id' => 'float'
	];
