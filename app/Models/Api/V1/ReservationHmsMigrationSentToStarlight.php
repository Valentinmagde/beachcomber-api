...
/**
 * Class ReservationHmsMigrationSentToStarlight
 * 
 * @property int $id
 ...
 * @package App\Models
 */
class ReservationHmsMigrationSentToStarlight extends Model
{
	protected $table = 'reservation_hms_migration_sent_to_starlight';
