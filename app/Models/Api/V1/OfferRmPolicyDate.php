 ...
 * @property Carbon|null $departure_from
 * @property Carbon|null $departure_to
 *
 * @package App\Models
 */
class OfferRmPolicyDate extends Model
{
	protected $table = 'offer_rm_policy_date';
