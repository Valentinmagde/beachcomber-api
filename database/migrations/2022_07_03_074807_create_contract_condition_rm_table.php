...
class CreateContractConditionRmTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contract_condition_rm', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('contract_condition_rm');
    }
}
