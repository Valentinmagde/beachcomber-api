...
class CreateRoomAllotment20210634Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('room_allotment-20210634', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('room_allotment-20210634');
    }
}
