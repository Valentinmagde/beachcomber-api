...
class CreateCustomerImport0110Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_import_01_10', function (Blueprint $table) {
            ...
            $table->string('hms_customer_id')->nullable();
    ...
    {
        Schema::dropIfExists('customer_import_01_10');
    }
}
