...
class CreateReservationHmsMigrationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservation_hms_migration', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservation_hms_migration');
    }
}
