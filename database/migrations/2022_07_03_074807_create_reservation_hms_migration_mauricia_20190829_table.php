...
class CreateReservationHmsMigrationMauricia20190829Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservation_hms_migration_mauricia_20190829', function (Blueprint $table) {
            ...
            $table->string('HMSReference')->nullable();
    ...
    {
        Schema::dropIfExists('reservation_hms_migration_mauricia_20190829');
    }
}
