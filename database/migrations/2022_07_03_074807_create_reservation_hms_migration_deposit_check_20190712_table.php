...
class CreateReservationHmsMigrationDepositCheck20190712Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservation_hms_migration_deposit_check_20190712', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservation_hms_migration_deposit_check_20190712');
    }
}
