...
class CreateMigrationReservationStarlightHmsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('migration_reservation_starlight_hms', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('migration_reservation_starlight_hms');
    }
}
