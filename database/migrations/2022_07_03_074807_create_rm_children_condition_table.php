...
class CreateRmChildrenConditionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rm_children_condition', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rm_children_condition');
    }
}
