...
class CreateRateStrategyMarketTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rate_strategy_market', function (Blueprint $table) {
            $table->bigIncrements('hotel_market_rate_strategy_id');
            $table->unsignedInteger('hotel_id')->nullable()->default(0);
            $table->unsignedBigInteger('hotel_market_id')->nullable();
    ...
    {
        Schema::dropIfExists('rate_strategy_market');
    }
}
