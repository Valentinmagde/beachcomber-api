...
class CreateHotelPmsEndpoint20120212Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hotel_pms_endpoint_20120212', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hotel_pms_endpoint_20120212');
    }
}
