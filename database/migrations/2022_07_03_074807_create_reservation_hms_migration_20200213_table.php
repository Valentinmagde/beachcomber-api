...
class CreateReservationHmsMigration20200213Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservation_hms_migration_20200213', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservation_hms_migration_20200213');
    }
}
