...
class CreateReservationStlCancelTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reservation_stl_cancel', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reservation_stl_cancel');
    }
}
